...
<div class="content_wrap_inner">
	...
	<p>Allow
	<?= form_dropdown('module_allow', config_item('yes_or_no'), $settings['blog']['comments_allow']) ?>
	</p>

	<p>Comments Per-Page
	<?= form_dropdown('module_per_page', config_item('amount_increments_five'), $settings['blog']['comments_per_page']) ?>
	</p>
